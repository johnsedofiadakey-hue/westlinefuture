      ...
      <div className="pulse-inner" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <span className="lxf" style={{ fontSize: 11, letterSpacing: '.1em', textTransform: 'uppercase', color: `var(--text-secondary)` }}>{label}</span>
            <div className="lxfh" style={{ fontSize: 28, marginBottom: 0, color: `var(--accent-secondary)` }}>{value}{unit}</div>
          </div>
          <div style={{ 
          ...
          {achievement !== null && (
            <div style={{ marginBottom: trend !== 0 ? 12 : 0 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                <span className="lxf" style={{ fontSize: 10, color: `var(--text-secondary)`, fontWeight: 600 }}>ACHIEVEMENT</span>
