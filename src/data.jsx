...
export const CLIENT_PROJECT_STAGES = [
  {
    id: 1, name: 'Onboarding, Payment & Site Survey', short: 'Onboarding', emoji: '📋',
    color: `var(--text-secondary)`, pct: 8, days: 10,
    statusLabel: 'Onboarding and technical survey', icon: 'search',
    whoActs: 'both',
    clientMsg: 'Complete onboarding, pay the separate rendering fee, and schedule the technical site visit.',
    adminPrompt: 'Confirm onboarding, rendering payment, appointment, worker assignment, measurements, photos, and survey completion.',
    tasks: ['Complete client onboarding', 'Verify rendering fee', 'Schedule site visit', 'Assign technical team', 'Capture measurements and photos'],
  },
  {
    id: 2, name: '3D Rendering Review', short: 'Rendering', emoji: '🎨',
    color: '#9333EA', pct: 18, days: 10,
    statusLabel: '3D rendering and revisions', icon: 'palette',
    whoActs: 'client',
    clientMsg: 'Review the 3D rendering, request changes where needed, and approve the final version.',
    adminPrompt: 'Prepare the rendering from verified site measurements, manage revisions, and obtain final client approval.',
    tasks: ['Prepare 3D rendering', 'Upload client version', 'Manage revision requests', 'Client approves final design'],
    requiresDesignApproval: true,
  },
  {
    id: 3, name: 'Commercial Approval & Production Authority', short: 'Commercial', emoji: '💳',
    color: `var(--accent-primary)`, pct: 32, days: 14,
    statusLabel: 'Quote, contract, payment and deliverables', icon: 'dollar-sign',
    whoActs: 'client',
    clientMsg: 'Negotiate and approve the quotation, sign the contract, make the initial payment, then sign the final deliverables document.',
    adminPrompt: 'Guide quotation negotiation, contract signature, payment verification, and final scope/deliverables approval before production.',
    tasks: ['Issue versioned quotation', 'Resolve cost changes', 'Client approves quotation', 'Client signs contract', 'Verify initial payment', 'Upload final deliverables', 'Client authorises production'],
    needsClientApproval: true, requiresPayment: true, paymentPct: 60,
  },
  {
  ...
  },
  {
    ...
    whoActs: 'admin',
    clientMsg: 'Cargo is in transit to Ghana. Shipping details and ETA remain visible while you track delivery.',
    adminPrompt: 'Publish shipment details and ETA. When goods arrive in Ghana, trigger the final goods balance and prepare the separate installation invoice.',
    tasks: ['Dispatched from factory', 'Publish vessel, container and ETA', 'Customs clearance processed', 'Confirm arrival in Ghana', 'Collect final goods balance', 'Prepare installation add-on invoice'],
  },
  {
    ...
    whoActs: 'worker',
    clientMsg: 'Your goods balance and installation invoice are paid. Our technical crew is on-site fitting and finishing all components.',
    adminPrompt: 'Begin only after Ghana arrival, final goods balance, installation add-on payment, and crew assignment are confirmed.',
    tasks: ['Verify goods balance', 'Verify installation add-on payment', 'Assign field crew', 'Site prepared and secured', 'Complete installation', 'Upload daily photos'],
  ...
  {
    id: 8, name: 'Handover & Closeout', short: 'Completion', emoji: '🌟',
