    ...
    if (this.state.hasError) {
      return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#F8F6F3', fontFamily: 'sans-serif', padding: 40 }}>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 800, color: '#0D0B2E', marginBottom: 8 }}>Something went wrong</h1>
          ...
          <button
            ...
            style={{ padding: '12px 28px', background: '#0D0B2E', color: '#fff', border: 'none', borderRadius: 10, fontSize: 13, fontWeight: 700, cursor: 'pointer', letterSpacing: '0.05em' }}>
            Reload Page
          </button>
          {import.meta.env.DEV && (
