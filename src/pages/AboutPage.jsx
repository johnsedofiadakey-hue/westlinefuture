    ...
    <div style={{ paddingTop: mob ? 80 : 120, fontFamily: 'Inter, Satoshi, sans-serif' }}>
      ...
      <section style={{ padding: mob ? '60px 24px 40px' : '80px 5vw 60px', background: `var(--bg-secondary)` }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: mob ? 16 : 22, color: 'rgba(92, 58, 33,0.55)', maxWidth: 760, lineHeight: 1.7 }}>
      ...
      <section style={{ padding: mob ? '60px 24px' : '100px 5vw', background: '#fff' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: mob ? '1fr' : '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: 'rgba(92, 58, 33,0.6)', lineHeight: 1.85, fontSize: 16, marginBottom: 32 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, padding: 24, background: `var(--bg-secondary)`, borderRadius: 20, border: '1px solid var(--border-color)' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: 'rgba(92, 58, 33,0.5)' }}>{brand.location || 'Spintex Road Industrial Area, International'}</div>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, padding: 24, background: `var(--bg-secondary)`, borderRadius: 20, border: '1px solid var(--border-color)' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: 'rgba(92, 58, 33,0.5)' }}>All 16 regions of Ghana — field teams deployed nationwide</div>
                </div>
              </div>
            </div>
          </div>
          <div style={{ position: 'relative' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: `var(--text-secondary)` }}>Delivered since 2012</div>
              </div>
            </div>
          </div>
        </div>
            ...
            {VALUES.map((v, i) => (
              <div
                ...
                style={{
                  ...
                  border: '1px solid',
                  borderColor: i === 0 ? DARK_TEXT : `var(--border-color)`,
      ...
      <section style={{ padding: mob ? '60px 24px' : '100px 5vw', background: '#fff' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative' }}>
            <div style={{ position: 'absolute', left: mob ? 20 : '50%', top: 0, bottom: 0, width: 2, background: `var(--border-color)`, transform: mob ? 'none' : 'translateX(-50%)' }} />
      ...
      {/* ── CERTIFICATIONS ── */}
      <section style={{ padding: mob ? '60px 24px' : '80px 5vw', background: '#fff', borderTop: '1px solid var(--border-color)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: mob ? '1fr 1fr' : 'repeat(4, 1fr)', gap: 16 }}>
            {[
              ...
              <div key={c.label} style={{ padding: 28, background: `var(--bg-secondary)`, borderRadius: 20, border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={{ fontSize: 12, color: `var(--text-secondary)`, fontWeight: 600 }}>{c.sub}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            {navigate && (
              <button
                ...
                style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '18px 40px', background: ac, color: `var(--bg-primary)`, border: 'none', borderRadius: 14, fontWeight: 900, fontSize: 15, cursor: 'pointer' }}
              >
