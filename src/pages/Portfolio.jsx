    ...
    >
      ...
      <div style={{ padding: mob ? '0' : '40px 5vw', display: 'grid', gridTemplateColumns: mob ? '1fr' : 'repeat(12, 1fr)', gap: mob ? 32 : 64 }}>
        ...
        <div style={{ gridColumn: mob ? 'auto' : 'span 8' }}>
           <div style={{ position: 'relative', height: mob ? 400 : 650, width: '100%', overflow: 'hidden', borderRadius: mob ? 0 : 32, background: '#F4F4FA', boxShadow: '0 30px 60px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ gridColumn: mob ? 'auto' : 'span 4', padding: mob ? '0 20px 100px' : '0' }}>
           <div style={{ position: 'sticky', top: 120 }}>
              ...
              <p style={{ fontSize: 16, color: 'rgba(13,11,46,0.6)', lineHeight: 1.6, marginBottom: 40 }}>{project.desc || 'A premium structural execution showcasing Westline Future’s capability in high-fidelity interior finishing and industrial-grade glass engineering.'}</p>
              ...
              <div style={{ padding: 32, background: '#F4F4FA', borderRadius: 32, border: '1px solid rgba(0,0,0,0.05)' }}>
