  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          <h2 className="lxfh" style={{ fontSize: 32, fontWeight: 400, color: '#111827', marginBottom: 4 }}>Inquiry Pipeline</h2>
              ...
              <tr key={e.id} style={{ borderBottom: '1px solid #f9f9f9' }}>
                ...
                <td style={{ padding: '16px 20px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    {e.type === 'Marketplace Order' ? <Package size={14} color="#16A34A" /> : <Mail size={14} color="#0F766E" />}
      ...
      {convertTarget && (
        <PModal open={!!convertTarget} title="Industrial Lead Provisioning" onClose={() => setConvertTarget(null)} w={1000}>
           <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                 <div style={{ background: '#F9FAFB', padding: 24, borderRadius: 20, border: '1px solid #99F6E4' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                       <div style={{ width: 40, height: 40, borderRadius: 12, background: '#111827', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          <User color="#0F766E" size={20} />
                       </div>
                       <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                 <div className="p-card" style={{ padding: 24, background: '#111827', color: '#fff', borderRadius: 24 }}>
