...
export default function AdminSystem({ onReset, syncCatalog, brand }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32, maxWidth: 800 }}>
       <div>
          <h2 className="lxfh" style={{ fontSize: 32, fontWeight: 400, color: '#111827' }}>System Maintenance</h2>
          <p className="lxf" style={{ color: '#6B7280', fontSize: 14 }}>Global environment controls and data synchronization tools.</p>
       </div>

        <div className="p-card" style={{ padding: 32, border: confirm ? `2px solid #EF4444` : '1px solid var(--border)' }}>
          <div style={{ display: 'flex', gap: 24 }}>
             <div style={{ width: 64, height: 64, borderRadius: 20, background: confirm ? '#FEF2F2' : '#F9FAFB', display: 'flex', alignItems: 'center', justifyContent: 'center', color: confirm ? '#EF4444' : ac }}>
                <Database size={32} />
             </div>
             <div style={{ flex: 1 }}>
                <h3 className="lxfh" style={{ fontSize: 20, marginBottom: 8 }}>Initialize / Reset Production Data</h3>
                <p className="lxf" style={{ fontSize: 13, color: '#4B5563', lineHeight: 1.6, marginBottom: 24 }}>
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  {!confirm ? (
                    <>
                      <button onClick={() => setConfirm(true)} className="p-btn-dark lxf" style={{ background: '#111827', padding: '12px 24px', fontSize: 13, display: 'flex', alignItems: 'center', gap: 10 }}>
       ...
       <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          <div className="p-card" style={{ padding: 24 }}>
             ...
             <p className="lxf" style={{ fontSize: 12, color: '#6B7280', marginBottom: 20 }}>Verify Firestore rules and storage bucket permissions.</p>
          ...
          <div className="p-card" style={{ padding: 24 }}>
             ...
             <p className="lxf" style={{ fontSize: 12, color: '#6B7280', marginBottom: 20 }}>Export current database snapshot to JSON format.</p>
             <button className="p-btn-light lxf" style={{ width: '100%', fontSize: 12 }}>Generate Backup</button>
          </div>
       </div>

       <div className="p-card" style={{ padding: 32, background: '#111827', color: '#fff' }}>
