    ...
    <div className="client-hub-container fade-in" style={{ padding: '20px 0' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 40 }}>
         <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <button onClick={onBack} aria-label="Go back" style={{ width: 44, height: 44, borderRadius: 14, background: '#F4F4FA', border: '1px solid #F0EBE5', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
               <ArrowLeft size={18} />
            </button>
            <div>
               ...
               <div className="fade-in">
                  ...
                  {myWorkOrders.length > 0 ? myWorkOrders.map(wo => (
                     <div key={wo.id} className="p-card" style={{ padding: 0, marginBottom: 24, overflow: 'hidden', border: '1px solid #F0EBE5' }}>
                        ...
                        <div style={{ padding: '16px 32px', background: '#F4F4FA', borderTop: '1px solid #F0EBE5', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
